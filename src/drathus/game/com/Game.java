...
public class Game {
	...
	private void initEntities() {
		for(int i = 0; i < (width / 100) + 1; i++) {
			for(int j = 0; j < (height / 100) + 1; j++) {
				Entity tile = new Stage(this, "grass.png", i * 100, j * 100);
				entities.add(tile);
			}
		}
		player = new Player(this, "man1_fr1.gif", width / 2 - 32, height / 2 - 32);
		player.playerSpeed = 140;
		entities.add(player);
		//Satellite moon = new Satellite(this, player, "satTest.gif", 1005);
		//entities.add(moon);
	}
	...
	public void frameRendering() {
		...
		if(Keyboard.isKeyDown(Keyboard.KEY_LEFT) ||
				Keyboard.isKeyDown(Keyboard.KEY_A)) player.dx = -player.playerSpeed;
		if(Keyboard.isKeyDown(Keyboard.KEY_RIGHT) ||
				Keyboard.isKeyDown(Keyboard.KEY_D)) player.dx = player.playerSpeed;
		if(Keyboard.isKeyDown(Keyboard.KEY_DOWN) ||
				Keyboard.isKeyDown(Keyboard.KEY_S)) player.dy = player.playerSpeed;
		if(Keyboard.isKeyDown(Keyboard.KEY_UP) ||
				Keyboard.isKeyDown(Keyboard.KEY_W)) player.dy = -player.playerSpeed;
